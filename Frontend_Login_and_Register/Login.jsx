...
const Login = () =>{
  ...
  return (
    ...
    type="email" id="correo" name= "correo" placeholder="Correo electrónico..." autoComplete="on" value={correo} />
    </div>
    ...
    <input onChange={(e) => onChange(e)}
     type="password" id="contrasena" name= "contrasena" placeholder="Contrasena..." autoComplete="on" value={contrasena}  />
    </div>
